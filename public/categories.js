...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    'campaign-item': _components_CampaignItem_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  data: function data() {
    return {
      campaigns: [],
  ...
  methods: {
    go: function go() {
      ...
      axios.get(url).then(function (response) {
        ...
        _this.lengthPage = data.campaigns.last_page; // consoloe.log(this.lengthPage)
      })["catch"](function (error) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    this.provider = this.$route.path.split('/')[3]; // console.log(this.code)
                  ...
                  _c("v-simple-table", { attrs: { dense: "" } }, [
                    _c("tbody", [
                      _c("tr", [
                        ...
                        _vm._v(" "),
                        _c("td", [
                          _vm._v(" " + _vm._s(_vm.campaign.address) + " ")
                        ])
                      ]),
                      _vm._v(" "),
                      _c("tr", [
...
var render = function() {
  ...
  return _c(
    "div",
    { attrs: { "background-color": "grey darken-3" } },
    [
      _c(
        "v-container",
        { staticClass: "ma-0 pa-0", attrs: { "grid-list-sm": "" } },
    ...
    [
      _c(
        "v-container",
        {
          ...
          attrs: { "grid-list-sm": "", "background-color": "grey darken-3" }
        },
        [
          _c(
            "div",
